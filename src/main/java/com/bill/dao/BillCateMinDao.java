...
@Repository
public interface BillCateMinDao {
     ...
     * @param billCateMin
     */
    void delOnBillCateMinInfo(BillCateMin billCateMin);
     ...
     */
    void delSelectBillCateMin(@Param("userId") Integer userId,@Param("billCateMinIds") Integer[] billCateMinIds);
     ...
     * @return
     */
    List<BillCateMin> queryBillCateMinInfo(@Param("userId")Integer userId,@Param("billCategoryId") Integer billCategoryId);
}
